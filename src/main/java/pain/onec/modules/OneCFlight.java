...
public class OneCFlight extends Module {
    ...
    private final SettingGroup sgAntiKick = settings.createGroup("Anti Kick"); // Poggers
    ...
    public OneCFlight() {
        super(OneC.Main1c, "betterFlight", "FLYYYY! No Fall is recommended with this module.\nAbilities is recommended have very, very low off time with normal anti-kick.");
    }
    ...
    private void onPostTick(TickEvent.Post event) {
        ...
        if (offLeft <= 0 && delayLeft <= 0) {
            ...
            if (antiKickMode.get() == AntiKickMode.Normal) {
			    ...
			    BlockPos pos = playerPos.add(0, -1, 0);
